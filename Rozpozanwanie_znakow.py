...
# wczytujemy nasz model wersja niezbalansowana

model = tf.keras.models.load_model("./my_model_30_epok_nzb_25_06_22.hdf5")
model.summary()
# mozemy wczytać nasz model wersji z danymi zbalansowanymi
# model = tf.keras.models.load_model("./my_model_30_epok_zb_29_06_22_nowy.hdf5")
# model.summary()
